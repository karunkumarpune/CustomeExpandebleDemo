...
import karunkumar.com.expandebledemo.model.Answer
...
class SchedulAdapter(val context: Context, val list: ArrayList<Result>) : RecyclerView.Adapter<SchedulAdapter.MyViewHolder>() {
    var flags = true
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.completed_deliveries_list_item, parent, false)
